...
- 既有 Button、Icon button、Switch、Checkbox、Radio、Split button／Dropdown、Text input／Textarea 與色票的規格化盤點，以及由此延伸的 Badge／Tag、Inline alert 候選向量稿、PNG 校準預覽與 framework-neutral design token 草稿。
...
│  ├─ everline-agent-components-v0.1.svg # Agent 延伸候選向量稿
│  └─ 72ppi/                  # 現有設計預覽與交換格式
├─ exports/
│  └─ everline-agent-components-v0.1.png # 候選稿校準預覽
├─ tokens/
